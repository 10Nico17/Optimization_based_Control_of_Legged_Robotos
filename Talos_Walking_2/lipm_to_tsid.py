...
if __name__=='__main__':
    ...
    for i in range(3):
        ...
        plt.legend()
        plt.savefig(f"x_RF_LF_dim_{i}.png")  # Speichert den ersten Plot in eine PNG-Datei
    ...
    for i in range(2):
        ...
        plt.legend()
        plt.savefig(f"CoP_CoM_dim_{i}.png")  # Speichert den ersten Plot in eine PNG-Datei
